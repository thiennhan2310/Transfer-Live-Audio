 ...
 */
public class callReceive implements ReceiveStreamListener, SessionListener, 
	ControllerListener
{
    ...
    public callReceive(String sessions[]) {
...
//	
//            String [] session={"192.168.10.102/22222"};
//	AVReceive2 avReceive = new AVReceive2(session);
